...
def add_mm_charges(scf_method, atoms_or_coords, a, charges, radii=None, rcut=None, unit=None, Lall0=False):
    ...
    return qmmm_for_scf(scf_method, mm_mol, Lall0=Lall0)

def qmmm_for_scf(scf_method, mm_mol, Lall0=False):
    ...
    class QMMM(_QMMM, method_class):
        ...
        def get_mm_ewald_pot(self, mol, mm_mol):
            return self.mm_mol.get_ewald_pot(
                mol.atom_coords(),
                mm_mol.atom_coords(), mm_mol.atom_charges(), Lall0=self.Lall0)

        def get_qm_ewald_pot(self, mol, dm):
            # d^2 Epbc / dq_i dq_j
            self.qm_ewald_hess = self.mm_mol.get_ewald_pot(mol.atom_coords(), Lall0=self.Lall0)
