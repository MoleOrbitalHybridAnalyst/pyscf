...
def add_mm_charges(scf_method, atoms_or_coords, a, charges, radii=None, rcut=None, grid_spacing=None, unit=None):
    ...
    mm_mol = mm_mole.create_mm_mol(atoms_or_coords, a, charges,
                        radii=radii, rcut=rcut, grid_spacing=grid_spacing, unit=unit)
