...
def add_mm_charges(scf_method, atoms_or_coords, a, charges, radii=None, 
        rcut_ewald=None, rcut_dip=None, unit=None):
    ...
    mm_mol = mm_mole.create_mm_mol(atoms_or_coords, a, charges, radii=radii, 
            rcut_ewald=rcut_ewald, rcut_dip=rcut_dip,
            unit=unit)
...
def qmmm_for_scf(scf_method, mm_mol):
    ...
    class QMMM(_QMMM, method_class):
        ...
        def get_hcore(self, mol=None, rcut_dip=None, s1r=None):
            ...
            assert rcut_dip < np.min(r_qm_qm), "QM image is within rcut_dip of QM"
            Ls[Ls == np.inf] = 0.0
            ...
            if mm_mol.charge_model == 'gaussian':
                expnts = np.hstack([mm_mol.get_zetas()] * 27)[mask]
            ...
            # charges beyond rcut_dip will be handled by ewald
...
#            print("qaud energy:", lib.einsum('ixy,ixy->', ewald_pot, self.get_qm_quadrupoles(dm)))
        ...
        def energy_nuc(self):
            ...
            # select mm atoms within rcut_dip
            mol = self.mol
            ...
            dist2 = all_coords - qm_center
            dist2 = lib.einsum('ix,ix->i', dist2, dist2)
            mask = dist2 <= self.mm_mol.rcut_dip**2
            charges = all_charges[mask]
            coords = all_coords[mask]
